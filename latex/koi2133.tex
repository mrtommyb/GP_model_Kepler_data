...
The probability of the model given the data is proportional to the likelihood of the data given the model multiplied by our priors. The likelihood function we use assumes Gaussian residuals 
=======
